// 香港国际机场实时METAR和TAF数据获取 - Vercel Functions版本
class WeatherService {
    constructor() {
        // 使用相对路径指向Vercel Function
        this.metarAPI = '/api/weather?type=metar&station=VHHH';
        this.tafAPI = '/api/weather?type=taf&station=VHHH';
